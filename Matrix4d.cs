...
namespace NVecMath
{
	...
	{
		internal const long serialVersionUID = 8223903484171633710L;
		...
		/// <summary>Constructs and initializes a Matrix4d from the specified 16 values.</summary>
		/// <remarks>Constructs and initializes a Matrix4d from the specified 16 values.</remarks>
		...
		public Matrix4d(double m00, double m01, double m02, double m03, double m10, double
			 m11, double m12, double m13, double m20, double m21, double m22, double m23, double
			 m30, double m31, double m32, double m33)
		{
			// Compatible with 1.1
			this.m00 = m00;
			this.m01 = m01;
		...
		/// <remarks>Constructs and initializes a Matrix4d to all zeros.</remarks>
		public Matrix4d()
		{
			this.m00 = 0.0;
			this.m01 = 0.0;
		...
		/// <remarks>Returns a string that contains the values of this Matrix4d.</remarks>
		...
		/// <remarks>Sets this Matrix4d to identity.</remarks>
			...
			switch (row)
			{
				case 0:
				{
					switch (column)
					{
						...
						default:
						{
							throw new IndexOutOfRangeException("Matrix4d setElement");
						}
					}
					break;
				}
		...
		public double GetElement(int row, int column)
		{
			...
			throw new IndexOutOfRangeException("Matrix4d getElement");
		}
		...
		/// </remarks>
		/// <param name="column">the matrix column</param>
		/// <param name="v">the array into which the matrix column values will be copied</param>
		...
		/// the Matrix3d parameter.
		/// </remarks>
		/// <param name="m1">the matrix into which the rotational component is placed</param>
		...
		/// <remarks>Sets the specified row of this matrix4d to the four values provided.</remarks>
		/// <param name="row">the row number to be modified (zero indexed)</param>
		...
		/// <remarks>Sets the specified column of this matrix4d to the four values provided.</remarks>
		/// <param name="column">the column number to be modified (zero indexed)</param>
		...
		public void SetColumn(int column, double x, double y, double z, double w)
		{
			switch (column)
			{
				...
				default:
				{
					throw new IndexOutOfRangeException("Matrix4d setColumn");
				}
			}
		}

		/// <summary>Sets the specified column of this matrix4d to the vector provided.</summary>
		/// <remarks>Sets the specified column of this matrix4d to the vector provided.</remarks>
		/// <param name="column">the column number to be modified (zero indexed)</param>
		...
		/// array will be copied into the first row of this matrix, etc.).
		/// </remarks>
		/// <param name="m">the double precision array of length 16</param>
		...
		/// </remarks>
		internal void InvertGeneral(Matrix4d m1)
		{
		...
		public virtual bool Equals(Matrix4d m1)
		{
			try
			{
		...
		[System.ObsoleteAttribute(@"Use epsilonEquals(Matrix4d,double) instead")]
		...
		{
			Matrix4d m1 = null;
			m1 = (Matrix4d)base.MemberwiseClone();
