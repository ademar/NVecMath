...
namespace NVecMath
{
	...
	/// </remarks>
	[System.Serializable]
	public abstract class Tuple2f : ICloneable
	{
		internal const long serialVersionUID = 9011180388985266884L;
		...
		/// <remarks>Constructs and initializes a Tuple2f from the specified xy coordinates.</remarks>
		...
		/// <remarks>Constructs and initializes a Tuple2f from the specified array.</remarks>
		...
		/// <remarks>Constructs and initializes a Tuple2f from the specified Tuple2f.</remarks>
		...
		/// <remarks>Constructs and initializes a Tuple2f from the specified Tuple2d.</remarks>
		...
		/// <remarks>Constructs and initializes a Tuple2f to (0,0).</remarks>
		public Tuple2f()
		{
			this.x = (float)0.0;
			this.y = (float)0.0;
		...
		/// <remarks>Sets the value of this tuple to the value of the Tuple2f argument.</remarks>
		...
		public virtual bool Equals(Tuple2f t1)
		{
			try
			{
		...
		/// <summary>Returns a string that contains the values of this Tuple2f.</summary>
		/// <remarks>
