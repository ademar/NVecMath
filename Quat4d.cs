...
namespace NVecMath
{
	...
	{
		new internal const long serialVersionUID = 7577479888820201099L;
		...
		/// <summary>Constructs and initializes a Quat4d from the specified xyzw coordinates.
		/// 	</summary>
		/// <remarks>Constructs and initializes a Quat4d from the specified xyzw coordinates.
		/// 	</remarks>
		...
		/// <remarks>Constructs and initializes a Quat4d from the array of length 4.</remarks>
		...
		/// <remarks>Constructs and initializes a Quat4d to (0,0,0,0).</remarks>
		public Quat4d() : base()
		{
		}
		...
		{
			double norm;
			norm = 1.0 / (this.w * this.w + this.x * this.x + this.y * this.y + this.z * this
				.z);
			this.w *= norm;
			this.x *= -norm;
			this.y *= -norm;
